...
import { AutoSizeInputContext } from './AutoSizeInputContext.js';
...
const Input = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cx(styles.wrapper, className), "data-testid": "input-wrapper", children: [
