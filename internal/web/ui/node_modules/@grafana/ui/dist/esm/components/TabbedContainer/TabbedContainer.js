...
function TabbedContainer({ tabs, defaultTab, closeIconTooltip, onClose, testId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles.container, "data-testid": testId, children: [
    ...
    /* @__PURE__ */ jsx(ScrollContainer, { height: autoHeight, children: /* @__PURE__ */ jsx(TabContent, { className: styles.tabContent, children: (_a = tabs.find((t) => t.value === activeTab)) == null ? void 0 : _a.content }) })
  ] });
}
