...
exports.getNavigationTimings = void 0;
...
function getNavigationTimings(pushEvent, ignoredUrls) {
    ...
    var observer = new PerformanceObserver(function (observedEntries) {
        ...
        if (navigationEntryRaw == null || (0, performanceUtils_1.entryUrlIsIgnored)(ignoredUrls, navigationEntryRaw.name)) {
            return;
        }
