...
const calculateFieldTransformer = {
  ...
  operator: (options, ctx) => (outerSource) => {
    ...
    const isBinaryFixed = mode === "binary" /* BinaryOperation */ && ((_b = options.binary) == null ? void 0 : _b.right.fixed) != null;
        ...
        switch (mode) {
          ...
          case "binary" /* BinaryOperation */:
            ...
            if (((_h = (_g = binaryOptions.left) == null ? void 0 : _g.matcher) == null ? void 0 : _h.id) && ((_i = binaryOptions.left) == null ? void 0 : _i.matcher.id) === FieldMatcherID.byType) {
              ...
              const outFrames2 = data.map((frame) => {
                ...
                frame.fields.map((field, index) => {
                  ...
                  if (field.type === fieldType) {
                    ...
                    if (!left || !right || !operator2) {
                      return void 0;
                    }
                    const arr = new Array(left.length);
                    for (let i = 0; i < arr.length; i++) {
                      arr[i] = operator2.operation(left[i], right[i]);
                    }
                    const newField = {
                      ...field,
              ...
              creator = getBinaryCreator(lodash.defaults(binaryOptions, defaultBinaryOptions), data, ctx);
            }
            break;
          case "index" /* Index */:
...
function findFieldValuesWithNameOrConstant(frame, value, allFrames, ctx) {
  ...
  if (value.matcher && value.matcher.id === FieldMatcherID.byName) {
    const name = ctx.interpolate((_a = value.matcher.options) != null ? _a : "");
  ...
  const v = parseFloat((_d = value.fixed) != null ? _d : ctx.interpolate((_c = (_b = value.matcher) == null ? void 0 : _b.options) != null ? _c : ""));
  if (!isNaN(v)) {
