...
FROM --platform="linux/x86_64" docker.io/grafana/alloy-build-image:v0.1.20 AS ui-build
ARG BUILDPLATFORM
...
FROM --platform="linux/x86_64" docker.io/grafana/alloy-build-image:v0.1.20 AS build
ARG BUILDPLATFORM
ARG TARGETPLATFORM
ARG TARGETOS
ARG TARGETARCH
