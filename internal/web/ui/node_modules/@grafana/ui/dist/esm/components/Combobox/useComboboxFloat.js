...
import { MENU_ITEM_FONT_WEIGHT, MENU_ITEM_FONT_SIZE, MENU_ITEM_PADDING, MENU_OPTION_HEIGHT, POPOVER_MAX_HEIGHT } from './getComboboxStyles.js';
...
const useComboboxFloat = (items, isOpen) => {
  ...
  const [popoverMaxSize, setPopoverMaxSize] = useState(void 0);
  ...
  const floatStyles = {
    ...
    maxWidth: popoverMaxSize == null ? void 0 : popoverMaxSize.width,
    minWidth: (_a = inputRef.current) == null ? void 0 : _a.offsetWidth,
    maxHeight: popoverMaxSize == null ? void 0 : popoverMaxSize.height
  };
